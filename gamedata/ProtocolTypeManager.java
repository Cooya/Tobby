...
import gamedata.context.GameRolePlayMountInformations;
...
import gamedata.context.HumanOptionObjectUse;
...
import gamedata.fight.GameFightMinimalStatsPreparation;
...
public class ProtocolTypeManager {
	...
	static {
		...
		types.put(180, GameRolePlayMountInformations.class);
		...
		types.put(360, GameFightMinimalStatsPreparation.class);
        ...
        types.put(449, HumanOptionObjectUse.class);
